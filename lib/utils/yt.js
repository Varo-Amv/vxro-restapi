  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      .then((data) => {
        ...
        const deskr = data.player_response.microformat.playerMicroformatRenderer.lengthSeconds
        const siz = data.player_response.videoInfo.midroll_prefetch_size
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      .then((data) => {
        ...
        const views = data.player_response.microformat.playerMicroformatRenderer.viewCount
        const published = data.player_response.microformat.playerMicroformatRenderer.publishDate
        const deskr = data.player_response.microformat.playerMicroformatRenderer.description.simpleText
